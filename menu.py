...
class UpgradeMenu:
    ...
    def reset_upgrades(self):
        """Reseta os upgrades (põe todos os upgrades comprados de volta para 0)."""
        self.purchased.clear()  # Limpa todos os upgrades comprados
        self.auto_click_timer = 0  # Resetando o temporizador do auto clicker
        self.lines.append("Upgrades e Auto Clicker resetados com sucesso!")  # Confirmação visual

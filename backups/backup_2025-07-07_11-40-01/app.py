...
def main():
    ...
    upgrade_menu = UpgradeMenu(screen, WIDTH, HEIGHT)  # ícone e menu no canto superior esquerdo
    ...
    while running:
        ...
        # Painel do menu de upgrades (aparece/desaparece)
        upgrade_menu.draw(score)

        # Ícone e menu do lado direito

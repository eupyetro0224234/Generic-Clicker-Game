...
def main():
    ...
    running = True
    while running:
        # Se estiver em fade-out de saída
        ...
        for event in pygame.event.get():
            # Se exit dialog ativo, ele trata primeiro
            if config_menu.exit_handler.active:
                config_menu.exit_handler.handle_event(event)
                continue

            # Prioridade total para ConfigMenu e seus submenus
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                # Primeiro, tenta tratar no upgrade_menu
                ...
                # Se nenhum menu aberto (ConfigMenu já está fechado aqui), tenta o botão principal
                button._update_rect()
        ...
        # Atualiza trackers para o menu de conquistas
        ...
        # Desenha upgrade menu e ícone de config

    ...
    while running:
        ...
        if upgrade_menu.auto_click_enabled():
            ...
            if auto_click_counter >= 40:
                auto_click_counter = 0
                score += upgrade_menu.get_auto_click_bonus()
                tracker.check_unlock(score)
                click_effects.append(ClickEffect(WIDTH // 2, HEIGHT // 2, f"+{upgrade_menu.get_auto_click_bonus()} (Auto)"))
        ...
        score_manager.save_data(
            ...
            upgrade_menu.purchased  # agora é dict, salve direto
        )

...
def main():
    ...
    tracker.unlocked = set(unlocked_achievements)
    ...
    config_menu.achievements_menu.tracker = tracker  # sincroniza menu
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                menus_abertos = (
                    ...
                    config_menu.exit_handler.active
                )
    ...
    score_manager.save_data(score, config_menu.controls_menu.visible, tracker.unlocked)
    pygame.quit()
    sys.exit()

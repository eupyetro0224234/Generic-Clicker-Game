...
def main():
    ...
    while running:
        ...
        for event in pygame.event.get():
            # 1) Se diálogo de saída está ativo, trate primeiro
            ...
            # 3) Prioridade total para ConfigMenu (ícone e submenus)
            ...
            # 5) Clique do mouse: trate UpgradeMenu e Botão
            if event.type == pygame.MOUSEBUTTONDOWN:
                # 5a) Primeiro, tente no UpgradeMenu (ícone ou compra)
                ...
                # 5b) Se nenhum menu consumiu, tente o botão principal
                button._update_rect()
        ...
        # --- Sincroniza conquistas para o menu ---

...
class ExitHandler:
    def __init__(self, screen, width, height):
        ...
        self.unlock_console = False  # <-- NOVA FLAG
    ...
    def start(self):
        ...
        self.alpha = 0
        self.fading_out = False
        self.unlock_console = False  # Reset da flag
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_BACKSPACE:
                ...
                text = self.user_text.strip().lower()
                if text == "sim":
                    self.fading_out = True
                elif text == "console":
                    self.unlock_console = True  # <-- Ativa o console
                    self.active = False
                else:
                    self.user_text = ""
    ...
    def draw(self):
        ...
        text_pos = (
            ...
            self.input_rect.y + (self.input_rect.height - user_text_surface.get_height()) // 2,
        )

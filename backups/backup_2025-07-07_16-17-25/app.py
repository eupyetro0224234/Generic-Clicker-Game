...
def main():
    ...
    # Para permitir que o console possa acessar/alterar score, cria funções auxiliares:
    def get_score():
        return score
    ...
    # Também conecta o console ao config_menu para controlar visibilidade e abertura
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                # Se console estiver aberto, não reseta ao pressionar 'r'

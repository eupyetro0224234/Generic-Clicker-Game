...
def main():
    ...
    TEXT_COLOR_SCORE = (120, 0, 60)  # Rosa escuro para o texto score
    ...
    config_menu.achievements_menu.achievements = achievements  # Carregar conquistas existentes
    ...
    while running:
            ...
            if event.type == pygame.QUIT:
                ...
                if config_menu.settings_menu.is_click_allowed(event.button):
                    if button.is_clicked(event.pos):
                        ...
                        # Exemplo de conquista: desbloquear aos 10 cliques
                        if score == 10 and "10 cliques" not in config_menu.achievements_menu.achievements:
                            config_menu.achievements_menu.add_achievement("10 cliques")
                        # Você pode adicionar mais conquistas aqui seguindo o modelo acima
        ...
        # Caixa do score rosa claro
        box_x, box_y = 20, 20
        box_w, box_h = 260, 60  # aumentei um pouco a caixa
    ...
    # Salva score, controles visíveis e conquistas ao sair
    score_manager.save_data(score, config_menu.controls_menu.visible, config_menu.achievements_menu.achievements)

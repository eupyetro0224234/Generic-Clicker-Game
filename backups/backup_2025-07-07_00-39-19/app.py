    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # 1. Verifica primeiro os menus que estão visíveis na frente
                ...
                # 2. Verifica o menu de upgrades
                if upgrade_menu.handle_event(event, score):
                    event_handled = True

                # 3. Verifica o ícone de configurações
                if config_menu.handle_event(event):
                    event_handled = True

                # 4. Se nenhum menu tratou o evento, verifica o botão principal

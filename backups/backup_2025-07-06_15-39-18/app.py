    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                # desativa clique se Configurações ou Conquistas estiver aberto
                ...
                if config_menu.settings_menu.is_click_allowed(event.button) and button.is_clicked(event.pos):
                    ...
                    tracker.check(score)
                    # salvar imediatamente após novo desbloqueio ou score incrementado
                    score_manager.save_data(
                        score,
                        config_menu.controls_menu.visible,
                        list(tracker.unlocked)
        ...
        # desenha menu de conquistas e popup

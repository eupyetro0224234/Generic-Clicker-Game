...
class ControlsMenu:
    def __init__(self, screen, window_width, window_height):
        ...
        self.controls_list = [
            ...
            ("Clique com o botão da rodinha do mouse", "Aumenta pontos"),
        ...
        # Aumentamos a largura para não cortar textos longos
        self.width = 600
        self.line_height = 50
    ...
    def draw(self):
        ...
        for i, (key, desc) in enumerate(self.controls_list):
            ...
            # Caixa da tecla (aumentada também)
            key_rect = pygame.Rect(self.x + 12, oy, 150, 28)
            ...
            # Texto da descrição reposicionado com segurança
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if not self.box_rect.collidepoint(event.pos):
                # Agora ele **não fecha** ao clicar fora — comportamento removido
                return False
        return False

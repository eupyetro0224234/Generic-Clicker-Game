...
def download_assets(screen, width, height):
    ...
    assets = [
        ("https://minecraft.wiki/images/Enchanted_Book.gif?b21c4", os.path.join(assets_path, "enchanted_book.gif")),
        ("https://i.postimg.cc/hGf3VRqY/image-removebg-preview-5.png", os.path.join(assets_path, "image-removebg-preview-5.png")),
        ("https://i.postimg.cc/yxVZWpPk/image-removebg-preview-6.png", os.path.join(assets_path, "image-removebg-preview-6.png")),
    ]

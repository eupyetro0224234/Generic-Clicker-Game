...
def main():
    ...
    def set_score(new_score): nonlocal score; score = new_score

    # Console (instanciado desde o início, mas invisível)
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if config_menu.handle_event(event):
                # Só desbloqueia a conquista se o console foi realmente ativado manualmente
                if config_menu.console_enabled and not tracker.unlocked.__contains__("activate_console"):
                    if console.visible:

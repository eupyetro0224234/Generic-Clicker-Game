...
class Console:
    ...
    def execute_command(self, command):
        ...
        # Limpa linhas e prepara só a saída deste comando
        self.lines = []
        ...
        if command == "help":
            ...
            # Ao digitar "exit", apenas fecha o console.
            self.visible = False
            self.lines.append("Console fechado. Para reabrir, use o menu de sair e digite 'console'.")
        else:
            self.lines.append(f"Comando desconhecido: {command}")

        # Mantém no máximo max_lines linhas (não ultrapassa)

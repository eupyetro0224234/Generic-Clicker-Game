...
def main():
    ...
    upgrade_menu = UpgradeMenu(screen, 0, 0, 220)  # ícone aparecerá no canto superior direito

    # Coloca o ícone dos upgrades ao lado do ícone do menu
    ...
    while running:
        ...
        # Desenha ícones do menu e upgrades (alinhar os dois)

...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height):
        ...
        self.fullscreen_config_visible = False  # flag para abrir o menu fullscreen
    ...
    def draw_menu(self):
        ...
        # Se o fullscreen estiver aberto, não desenha o menu pequeno nem os controles
        if self.fullscreen_config_visible:
            return
    ...
    def handle_event(self, event):
        # Se o fullscreen estiver visível, só ele deve processar eventos
        if self.fullscreen_config_visible:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    self.fullscreen_config_visible = False
                    return True
            # Ignora tudo que não for ESC
            return True

        # Se controles abertos, deixa controles tratarem o evento
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if self.icon_rect.collidepoint(event.pos):
                # Clique no ícone abre/fecha o menu pequeno (não fecha fullscreen)
                ...
                if rect.collidepoint(event.pos):
                    ...
                    if 0 <= index < len(self.options):
                        ...
                        if selected == "Controles":
                            ...
                            self.is_open = False
                            self.fullscreen_config_visible = True
                    return True
                else:
                    self.is_open = False
                    return True

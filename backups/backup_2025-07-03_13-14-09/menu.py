...
from controles import ControlsMenu  # Submenu de controles
    ...
    def handle_event(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN:
            if self.icon_rect.collidepoint(event.pos):
                # Abre ou fecha SOMENTE o menu principal (não fecha o de controles)
                if not self.controls_menu.visible:
                ...
                if rect.collidepoint(event.pos):
                    ...
                    if 0 <= index < len(self.options):
                        ...
                        if selected == "Controles":
                            ...
                            self.is_open = False
                            # Aqui você pode abrir o menu fullscreen de configurações futuramente
                        return True
                else:
                    self.is_open = False
                    return True
        ...
        # Enquanto o menu de controles estiver visível, captura eventos dele

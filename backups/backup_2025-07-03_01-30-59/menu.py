...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height):
        ...
        self.icon_rect.topright = (window_width - 6, 6)  # Mais perto da borda

        self.options = ["Volume: [•••••]", "Tema: Claro", "Controles"]

        # Altura total considerando as opções + espaçamento
    ...
    def draw_menu(self):
        ...
        width = 180
        vertical_padding = 6  # Espaço interno para não encostar no topo e na base do fundo azul

...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height, score_manager):
        self.screen = screen
        ...
        self.score_manager = score_manager  # Referência para salvar estado
        self.controls_menu = ControlsMenu(screen, window_width, window_height)
        self.controls_menu.visible = self.score_manager.controls_visible  # Carrega estado salvo
    ...
    def handle_event(self, event):
        ...
        if self.controls_menu.visible:
            if self.controls_menu.handle_event(event):
                self.score_manager.controls_visible = self.controls_menu.visible
                return True
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if self.icon_rect.collidepoint(event.pos):
                if self.controls_menu.visible:
                    ...
                    self.score_manager.controls_visible = False
                else:

    ...
    def handle_event(self, event):
        ...
        if self.console_instance and self.console_instance.visible:
            if self.console_instance.handle_event(event):
                # se digitou 'exit' dentro do console, execute_command já fez visible=False
                # aí removemos a opção Console do menu apenas nesse caso
        ...
        if self.exit_handler.active:
            ...
            # se digitou 'console' no ExitHandler, habilita novamente
        ...
        # 4) clique no ícone principal abre/fecha
        ...
        # 5) ESC fecha menus abertos; no console, só minimiza

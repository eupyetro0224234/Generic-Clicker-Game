...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height, w=300, h=200):
        ...
        # Link e caminho do ícone
        self.icon_url = "https://wiki.stardewvalley.net/mediawiki/images/d/d3/Optionstab.png"
        self.icon_path = os.path.join(self.assets_folder, "config_icon.png")

        # Baixa o ícone se não existir
    ...
    def draw_icon(self):
        if self.icon_image:
            ...
            # fallback ícone padrão se não carregou imagem

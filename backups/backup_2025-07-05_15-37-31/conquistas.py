...
class AchievementsMenu:
    ...
    def draw(self):
        ...
        # Caixa rosa clara para aviso temporário
        if self.showing_achievement:
            ...
            if now - self.achievement_start_time > self.achievement_duration:
                ...
                pygame.draw.rect(self.screen, (255, 192, 203), box_rect, border_radius=12)

                text_surf = self.font.render(self.achievement_text, True, (100, 0, 70))

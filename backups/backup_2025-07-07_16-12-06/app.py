...
def main():
    ...
    console.set_score_accessors(
        ...
        set_func=lambda val: nonlocal_set_score(val)
    )
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            # Envia eventos primeiro para menus e console para bloqueá-los corretamente
        ...
        # Desenha o console sempre visível (se estiver aberto)
        console.draw()

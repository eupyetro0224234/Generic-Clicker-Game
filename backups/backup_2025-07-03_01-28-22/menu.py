...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height):
        ...
        self.icon_rect.topright = (window_width - 12, 12)  # mais perto da borda
    ...
    def draw_menu(self):
        ...
        x = self.screen.get_width() - width - 12  # encostado na borda direita
    ...
    def handle_event(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            width = 180
            height = int(self.max_height * self.animation_progress)
            x = self.screen.get_width() - width - 12
            y = self.icon_rect.bottom + 8

...
class ConfigMenu:
    def __init__(self, screen, window_width, window_height, loading_callback=None):
        ...
        self.console = None  # Instância do console
    ...
    def draw(self):
        ...
        if self.console and self.console.visible:
            self.console.draw()
        ...
        if self.exit_handler.active:
            ...
            if self.exit_handler.user_text.strip().lower() == "console":
                ...
                if self.console is None:
                    self.console = open_console(self.screen, self.screen.get_width(), self.screen.get_height())
                else:

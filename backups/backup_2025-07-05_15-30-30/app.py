...
from conquistas import AchievementsMenu  # Importa conquistas
...
def main():
    ...
    score, controls_visible, unlocked_achievements = score_manager.load_data()
    ...
    achievements_menu.load_achievements(unlocked_achievements)
    config_menu.achievements_menu = achievements_menu  # Adiciona o menu conquistas no config_menu
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            # Se qualquer submenu estiver aberto, deixa ele tratar
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_r:
                    score = 0
                    # Desbloqueia conquista reset_score ao resetar pontuação
                    achievements_menu.unlock("reset_score")

        # Verifica conquistas com base no score e desbloqueia se for o caso
        if score >= 1:
            achievements_menu.unlock("first_click")
        if score >= 100:
            achievements_menu.unlock("hundred_points")
        ...
        # Desenha o aviso de conquista desbloqueada na tela
        achievements_menu.update_alert()
        achievements_menu.draw_alert()
    ...
    # Salva score, estado do menu controles e conquistas ao sair
    score_manager.save_data(score, config_menu.controls_menu.visible, achievements_menu.get_unlocked_ids())

            ...
            if self.is_open and hasattr(self, "menu_rect") and self.menu_rect.collidepoint(event.pos):
                ...
                if 0 <= index < len(self.options):
                    ...
                    if selected == "Controles":
                        ...
                        # Mantém menu principal aberto ao abrir submenu controles
                        self.is_open = True
                ...
                # Clique fora fecha só o menu principal, não fecha submenus
                self.is_open = False
                return True

        elif event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                # Esc fecha submenus antes do menu principal
                if self.settings_menu.visible:

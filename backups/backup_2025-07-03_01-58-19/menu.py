...
class ConfigMenu:
    ...
    def draw_menu(self):
        ...
        for i, option in enumerate(self.options):
            ...
            text_rect.x = option_rect.x + 12  # padding interno para o texto
                ...
                if rect.collidepoint(event.pos):
                    ...
                    if 0 <= index < len(self.options):
                        ...
                        if selected == "Controles":
                            # Alterna a visibilidade do menu controles
                            self.controls_menu.visible = not self.controls_menu.visible
                            self.is_open = False  # fecha menu principal ao abrir controles
                    return True
                # Removido fechamento do menu ao clicar fora da caixa
                # else:
                #     self.is_open = False
                #     return True

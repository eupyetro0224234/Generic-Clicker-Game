...
from conquistas import AchievementTracker  # Corrigido para importar o tracker com screen
from upgrades import UpgradesMenu  # Importa menu de upgrades
...
def main():
    ...
    score, controls_visible, achievements = score_manager.load_data()
    ...
    tracker.load_achievements(achievements)  # carrega conquistas salvas
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                # Bloqueia cliques se Config ou Conquistas estiverem abertos
        ...
        # Atualiza conquistas com o score atual
        ...
        # Botão para abrir menu de upgrades (abaixo da pontuação)
        ...
        # Desenha notificações de conquistas desbloqueadas
        tracker.draw_notifications()
    ...
    score_manager.save_data(score, config_menu.controls_menu.visible, tracker.get_achievements())

...
def main():
    ...
    # Integra o console na config_menu para controle
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if exit_handler.active:
                if exit_handler.handle_event(event):
                    if exit_handler.detected_console:
                        ...
                        # Se não detectou console, esconde o console (se aberto)
                        console.visible = False
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # ESC fecha/minimiza console sem apagar histórico
                if event.key == pygame.K_ESCAPE:
                    if console.visible:
                        console.visible = False  # só minimiza (não reseta)
                        continue
                    if exit_handler.active:
                        exit_handler.active = False
                        continue

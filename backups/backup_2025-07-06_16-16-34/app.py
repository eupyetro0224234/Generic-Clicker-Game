...
from conquistas import AchievementTracker  # corrigido para importar só o tracker
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                # Só permite clicar no botão se menus de Configurações e Conquistas estiverem fechados
                if not (config_menu.settings_menu.visible or config_menu.achievements_menu.visible):
                    if config_menu.settings_menu.is_click_allowed(event.button):
                        if button.is_clicked(event.pos):
                            ...
                            tracker.check_unlock(score)  # checa conquistas a cada clique
        ...
        # Ícone para abrir upgrades (caso já implementado)
        ...
        # Desenha a notificação de conquista desbloqueada
        tracker.draw_popup()
        ...
        # Atualiza lista de conquistas desbloqueadas no menu para exibir corretamente

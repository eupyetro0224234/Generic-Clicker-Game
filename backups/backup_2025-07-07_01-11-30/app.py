...
def main():
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            # Reset de progresso com tecla R
            ...
            # Submenus têm prioridade de eventos
            ...
            # Menu principal (ícone de engrenagem)
            if config_menu.handle_event(event):
                continue

            # Clique do mouse — botão principal ou upgrades
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Se não clicou no botão, tenta nos upgrades

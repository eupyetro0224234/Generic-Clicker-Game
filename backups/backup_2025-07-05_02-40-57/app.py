...
from diff_generator import comparar_com_backup_anterior  # ⬅️ NOVO

def main():
    pasta_do_projeto = os.path.dirname(os.path.abspath(__file__))
    pasta_de_backups = os.path.join(pasta_do_projeto, "backups")

    # Fazer backup e gerar changelog com comparação automática
    fazer_backup(pasta_do_projeto, pasta_de_backups)
    comparar_com_backup_anterior(pasta_de_backups)

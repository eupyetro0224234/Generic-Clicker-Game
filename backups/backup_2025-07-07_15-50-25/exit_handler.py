...
class ExitHandler:
    def __init__(self, screen, width, height):
        ...
        self.active = False
        self.user_text = ""
        self.detected_console = False  # flag para console
        ...
        self.prompt = "Tem certeza que deseja sair? Digite 'sim' para confirmar, 'console' para console, 'esc' pra cancelar:"
    ...
    def draw(self):
        ...
        prompt_s = self.prompt_font.render(self.prompt, True, self.text_color)
        prompt_r = prompt_s.get_rect(center=(self.width//2, self.bg_rect.y + 35))
        self.screen.blit(prompt_s, prompt_r)
        self.input_rect.centerx = self.width // 2
        self.input_rect.top = prompt_r.bottom + 8
        ...
        self.screen.blit(user_surface, (self.input_rect.x + 10,
                                        self.input_rect.y + (self.input_rect.height - user_surface.get_height())//2))

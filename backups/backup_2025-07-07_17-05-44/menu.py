...
class ConfigMenu:
    ...
    def enable_console(self):
        if not self.console_enabled:
            ...
            # Abre o console e limpa histórico toda vez que é ativado
    ...
    def handle_event(self, event):
                        ...
                        if sel == "Configurações":
                            ...
                            if self.console_instance:
                                ...
                                if self.get_score_callback and self.set_score_callback:
                                    self.enable_console()
                        self.is_open = False  # Fecha o menu após clique
                        return True
                else:
        ...
        if event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE:
            # Esc fecha menus ou console abertos, mas NÃO remove opção Console
            if self.console_instance and self.console_instance.visible:

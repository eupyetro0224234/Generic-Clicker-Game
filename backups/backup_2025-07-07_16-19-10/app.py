...
def main():
    ...
    # Instancia o console, começa oculto
    console = Console(screen, WIDTH, HEIGHT)
    console.visible = False  # NÃO abre o console no início

    # Funções para acesso ao score do console
    def get_score():
        return score
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                # Resetar pontos com 'r' apenas se console não estiver aberto
                ...
                # ESC fecha menus abertos e console
            ...
            # Trata eventos dos menus abertos
            ...
            # Console tem prioridade para eventos de teclado e input
            if console.visible and console.handle_event(event):
                continue

            # Evento para menu principal
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if upgrade_menu.visible:
                    ...
                    inside_panel = panel_rect.collidepoint(event.pos) or upgrade_menu.icon_rect.collidepoint(event.pos)
                ...
                # Se nenhum menu estiver aberto e console fechado, permite clicar botão principal
                if not (
        ...
        # Atualiza menus que dependem do tracker

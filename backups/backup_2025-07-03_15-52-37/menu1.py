...
class MainMenu:
    def __init__(self, screen, window_width, window_height, options, on_option_select):
        self.screen = screen
        ...
        self.on_option_select = on_option_select
    ...
    def handle_event(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN:
            if self.icon_rect.collidepoint(event.pos):
                ...
                return True
            if self.is_open and self.menu_rect and self.menu_rect.collidepoint(event.pos):
                ...
                if 0 <= index < len(self.options):
                    ...
                    self.on_option_select(selected)
                    return True
                return True
            else:
                self.is_open = False

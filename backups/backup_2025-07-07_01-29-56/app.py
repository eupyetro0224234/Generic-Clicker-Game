...
def main():
    ...
    upgrade_menu = UpgradeMenu(screen, WIDTH, HEIGHT)  # upgrade ícone e menu no canto superior esquerdo
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Evento para o menu de upgrades
        ...
        # Desenha o menu de upgrades (ícone no topo esquerdo)
        upgrade_menu.draw(score)

        # Desenha ícone e menus da direita
